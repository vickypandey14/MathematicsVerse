           ...
           <div className="space-y-8 flex-grow">
              <div className="flex items-center space-x-3">
               ...
               <div className="space-y-2">
                  <h2 className="text-5xl md:text-6xl font-heading font-black text-foreground tracking-tighter leading-none">
                     READY TO <br />
                     <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-secondary font-black">PLAY?</span>
                  </h2>
            ...
            <div className="flex flex-col items-center md:items-end space-y-10 w-full md:w-auto">
               ...
               <div className="flex flex-col space-y-4 w-full sm:w-64">
                  <div className="p-6 rounded-3xl bg-foreground/[0.03] border border-border/80 dark:bg-white/5 dark:border-white/10 backdrop-blur-xl relative overflow-hidden group/stat shadow-sm hover:shadow-md transition-all duration-300">
                  ...
                  {quickMissions.map((m, i) => (
                    ...
                    >
                      <Link 
                       ...
                       title={m.name}
                       className={cn(
                         "w-16 h-16 rounded-2xl bg-card border border-border flex items-center justify-center transition-all hover:bg-card/80 shadow-xl group/btn overflow-hidden relative",
                         m.id === 'multiply' && 'hover:border-primary/50',
                         m.id === 'add' && 'hover:border-green-500/50',
                         m.id === 'subtract' && 'hover:border-blue-500/50',
                         m.id === 'roman' && 'hover:border-secondary/50',
                         m.color
                       )}
                      >
                        {/* The Glow Effect */}
