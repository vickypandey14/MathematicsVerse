        ...
        {isLoading ? (
          <div className="flex items-center justify-center min-h-[40vh]">
            <div className="text-center space-y-4">
              ...
              <p className="text-slate-500 font-black uppercase tracking-[0.2em] text-[10px]">Retrieving History...</p>
            </div>
          </div>
        ) : formulas.length > 0 ? (
          ...
          <div className="p-20 rounded-[48px] bg-white/[0.02] border border-white/5 border-dashed flex flex-col items-center justify-center text-center space-y-8">
            ...
            <div className="space-y-2">
              <h3 className="text-2xl font-heading font-black text-white uppercase tracking-tight">No history found</h3>
              <p className="text-slate-500 font-medium">You haven't explored any formulas yet. Start your journey now!</p>
            </div>
            <Link 
              href="/formulas" 
